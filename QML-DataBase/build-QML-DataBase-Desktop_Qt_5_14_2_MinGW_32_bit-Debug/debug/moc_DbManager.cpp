...
#include <memory>
#include "../../QML-DataBase/DbManager.h"
...
QT_MOC_LITERAL(1, 10, 10), // "insertUser"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 4), // "name"
QT_MOC_LITERAL(4, 27, 3), // "age"
QT_MOC_LITERAL(5, 31, 9), // "loadUsers"
QT_MOC_LITERAL(6, 41, 9), // "userModel"
QT_MOC_LITERAL(7, 51, 10) // "UserModel*"

    },
    "DbManager\0insertUser\0\0name\0age\0loadUsers\0"
    "userModel\0UserModel*"
};
...
void DbManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { bool _r = _t->insertUser((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])));
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< UserModel**>(_v) = _t->userModel(); break;
        default: break;
        }
